sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("df/com/training/FioriExercise01/app", ".html");
		...
		return Opa5.extend("df.com.training.FioriExercise01.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["df/com/training/FioriExercise01/localService/mockserver"], function (mockserver) {
