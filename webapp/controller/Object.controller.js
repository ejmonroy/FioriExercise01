		...
		return BaseController.extend("df.com.training.FioriExercise01.controller.Object", {
			...
			_onObjectMatched : function (oEvent) {
				...
				this.getModel().metadataLoaded().then( function() {
					var sObjectPath = this.getModel().createKey("ParameterSet", {
						// RicefId :  sObjectId
						RicefId: oObject.RicefId,
						Identifier: oObject.Identifier,
						Country: oObject.Country,
						ProgramId: oObject.ProgramId
					});
			...
			_onBindingChange : function () {
				...
				var oResourceBundle = this.getResourceBundle(),
					...
					sObjectName = oObject.Identifier;
